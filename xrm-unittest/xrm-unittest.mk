...
Objects0=$(IntermediateDirectory)/up_src_processor_ansi.cpp$(ObjectSuffix) $(IntermediateDirectory)/processor_ansi_ut.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_sdl2_net_SDLnet.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_sdl2_net_SDLnetselect.cpp$(ObjectSuffix) $(IntermediateDirectory)/access_condition_ut.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_access_condition.cpp$(ObjectSuffix) $(IntermediateDirectory)/users_dao_ut.cpp$(ObjectSuffix) $(IntermediateDirectory)/form_system_config_ut.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_communicator.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_socket_telnet.cpp$(ObjectSuffix) \
	...
	$(IntermediateDirectory)/up_src_sdl2_net_SDLnetUDP.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/processor_ansi_ut.cpp$(ObjectSuffix): processor_ansi_ut.cpp $(IntermediateDirectory)/processor_ansi_ut.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/Oblivion2-XRM/xrm-unittest/processor_ansi_ut.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/processor_ansi_ut.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/processor_ansi_ut.cpp$(DependSuffix): processor_ansi_ut.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/processor_ansi_ut.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/processor_ansi_ut.cpp$(DependSuffix) -MM processor_ansi_ut.cpp

$(IntermediateDirectory)/processor_ansi_ut.cpp$(PreprocessSuffix): processor_ansi_ut.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/processor_ansi_ut.cpp$(PreprocessSuffix) processor_ansi_ut.cpp
