...
CXX      := /usr/bin/clang++
CC       := /usr/bin/clang
CXXFLAGS :=  -Wfatal-errors -g -O0 -pedantic -W -std=c++11 -stdlib=libc++ -Wno-deprecated-declarations $(Preprocessors)
CFLAGS   :=  -Wfatal-errors -g -O0 -pedantic -W -std=c++11 -stdlib=libc++ -Wno-deprecated-declarations $(Preprocessors)
ASFLAGS  := 
AS       := /usr/bin/as
...
Objects1=$(IntermediateDirectory)/up_src_access_condition.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_form_manager.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_mods_mod_system_config.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_sdl2_net_SDLnet.cpp$(ObjectSuffix) \
...
$(OutputFile): $(IntermediateDirectory)/.d ".build-debug/SqliteWrapped" ".build-debug/xrm-menu-prompt-convert" ".build-debug/xrm-menu-convert" ".build-debug/xrm-unittest" $(Objects) 
	@$(MakeDirCommand) $(@D)
...
".build-debug/SqliteWrapped":
	@$(MakeDirCommand) ".build-debug"
	@echo stam > ".build-debug/SqliteWrapped"


".build-debug/xrm-menu-prompt-convert":
	@$(MakeDirCommand) ".build-debug"
	@echo stam > ".build-debug/xrm-menu-prompt-convert"


".build-debug/xrm-menu-convert":
	@$(MakeDirCommand) ".build-debug"
	@echo stam > ".build-debug/xrm-menu-convert"


".build-debug/xrm-unittest":
	@$(MakeDirCommand) ".build-debug"
	@echo stam > ".build-debug/xrm-unittest"
