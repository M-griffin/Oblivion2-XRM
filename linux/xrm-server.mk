...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)./Debug $(IncludeSwitch)../src $(IncludeSwitch)../sqlitewrap $(IncludeSwitch)../linux/Debug $(IncludeSwitch)/usr/include/python3.8 $(IncludeSwitch)/usr/local/include/pybind11 
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)SqliteWrapped $(LibrarySwitch)sqlite3 $(LibrarySwitch)pthread $(LibrarySwitch)ssl $(LibrarySwitch)crypto $(LibrarySwitch)yaml-cpp $(LibrarySwitch)util $(LibrarySwitch)ssh $(LibrarySwitch)uuid $(LibrarySwitch)python3.8 
ArLibs                 :=  "libSqliteWrapped.a" "sqlite3" "pthread" "ssl" "crypto" "yaml-cpp" "util" "libssh" "uuid" "python3.8" 
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch). $(LibraryPathSwitch)./Debug $(LibraryPathSwitch)../sqlitewrap $(LibraryPathSwitch)../linux/Debug $(LibraryPathSwitch)/usr/lib/python3.8 $(LibraryPathSwitch)/usr/lib/pybind11 
...
Objects1=$(IntermediateDirectory)/up_src_data-sys_users_dao.cpp$(ObjectSuffix) \
...
$(IntermediateDirectory)/up_src_process_posix.cpp$(ObjectSuffix): ../src/process_posix.cpp $(IntermediateDirectory)/up_src_process_posix.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "../src/process_posix.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_process_posix.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_src_python_system.cpp$(ObjectSuffix): ../src/python_system.cpp $(IntermediateDirectory)/up_src_python_system.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "../src/python_system.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_python_system.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/up_src_python_system.cpp$(DependSuffix): ../src/python_system.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/up_src_python_system.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/up_src_python_system.cpp$(DependSuffix) -MM ../src/python_system.cpp

$(IntermediateDirectory)/up_src_python_system.cpp$(PreprocessSuffix): ../src/python_system.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/up_src_python_system.cpp$(PreprocessSuffix) ../src/python_system.cpp
