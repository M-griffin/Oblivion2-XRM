...
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)SqliteWrapped $(LibrarySwitch)sqlite3 $(LibrarySwitch)pthread $(LibrarySwitch)ssl $(LibrarySwitch)crypto $(LibrarySwitch)yaml-cpp $(LibrarySwitch)util $(LibrarySwitch)uuid $(LibrarySwitch)boost_system $(LibrarySwitch)boost_thread 
ArLibs                 :=  "libSqliteWrapped.a" "sqlite3" "pthread" "ssl" "crypto" "yaml-cpp" "util" "uuid" "boost_system" "boost_thread" 
