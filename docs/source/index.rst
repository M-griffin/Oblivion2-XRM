...
| The Software is written in C++ supporting Windows, Linux, and OS/X at this time.
| Build Documentation below will help you explore the system locally if you wish to build the application
