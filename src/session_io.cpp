 ...
 * @return
 */
std::string SessionIO::getDefaultColor(Config &config) {
 ...
 * @return
 */
std::string SessionIO::getDefaultInputColor(Config &config) {
 ...
 * @return
 */
std::string SessionIO::getDefaultInverseColor(Config &config) {
 ...
 * @return
 */
std::string SessionIO::getDefaultPromptColor(Config &config) {
 ...
 * @return
 */
std::string SessionIO::getDefaultStatColor(Config &config) {
 ...
 * @return
 */
std::string SessionIO::getDefaultBoxColor(Config &config) {
 ...
 * @return
 */
std::string SessionIO::parseFormatColorsBrackets(const std::string &sequence, Config &config) {
    // Mocked up for now
 ...
 * @return
 */
std::string SessionIO::parseFormatColorsColon(const std::string &sequence, Config &config) {
    // Mocked up for now
    std::string output = sequence;
    output += getDefaultPromptColor(config);
    return output;
