...
// Base Dao Definition
using baseAccessLevelClass = BaseDao<AccessLevel>;
...
public:
    explicit AccessLevelDao(Database &database)
     ...
     * @return
     */
    bool updateRecord(AccessLevel &obj);
     ...
     * @return
     */
    long insertRecord(AccessLevel &obj);
     ...
     * @return
     */
    AccessLevel getRecordById(long id);

    /**
     * @brief Retrieve All Records in a Table
     * @return
     */
    std::vector<AccessLevel> getAllRecords();
     ...
     * @return
     */
    std::string insertAccessLevelQryString(std::string qry, AccessLevel &obj);
     ...
     * @return
     */
    std::string updateAccessLevelQryString(std::string qry, AccessLevel &obj);
     ...
     * @param obj
     */
    void pullAccessLevelResult(Query &qry, AccessLevel &obj);
     ...
     * @param values
     */
    void fillAccessLevelColumnValues(Query &qry, AccessLevel &obj,
     ...
     * @return
     */
    AccessLevel getAccessLevelByLevel(long access_level);
};
