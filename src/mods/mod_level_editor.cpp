...
ModLevelEditor::ModLevelEditor(Context &ctx)
    : ModBase(ctx, MOD_FILENAME)
      ...
      , m_current_level(0)
      , m_current_field(0) {
    m_setup_functions.emplace_back([this] { setupLevelEditor(); });
    m_setup_functions.emplace_back([this] { setupLevelEditFields(); });

    m_mod_functions.emplace_back(
        [this](const std::string &s) { return levelEditorInput(s); });
    m_mod_functions.emplace_back(
        [this](const std::string &s) { return levelEditorPausedInput(s); });
    m_mod_functions.emplace_back(
        [this](const std::string &s) { return levelEditorLevelInput(s); });

    m_mod_functions.emplace_back(
        [this](const std::string &s) { return levelEditorLevelFieldInput(s); });
    m_mod_functions.emplace_back(
        [this](const std::string &s) { return levelEditorLevelFieldHandler(s); });
...
bool ModLevelEditor::pollTimers() {
...
void ModLevelEditor::createTextPrompts() {
    ...
    value[PROMPT_HEADER] = std::make_pair("Level Editor Header",
                                          "|CS|CR|03--- |15[|03Oblivion/2 XRM |07// |11Level Editor|15] |03--- |CR");
    value[PROMPT_LEVEL_EDIT_HEADER] = std::make_pair("Level Fields Editor Header |OT Level ID",
                                                     "|CS|CR|03--- |15[|03Oblivion/2 XRM |07// |11Level Editor|15] |03--- |11Level ID : |15|OT |CR");
    value[PROMPT_PAUSE] = std::make_pair("Pause Prompt",
                                         "|CR |03- |15Hit any key to continue or (|03a|15)bort listing |03-|15 |CR");
    value[PROMPT_INPUT_TEXT] = std::make_pair("Level Edit Prompt",
                                              "|CR|03A|15/dd Level |03E|15/dit Level |03C|15/opy Level |03D|15/elete Level |03Q|15/uit : ");
    value[PROMPT_OPTION_INPUT_TEXT] = std::make_pair("Level Option Edit Prompt",
                                                     "|CR|03A|15/dd |03E|15/dit |03C|15/opy |03D|15/elete |03Q|15/uit : ");
    ...
    value[PROMPT_INVALID_LEVEL_EXISTS] = std::make_pair("Invalid Level Exists",
                                                        "|CR|04Invalid, Level already exist.|CR");
    value[PROMPT_INVALID_LEVEL_NOT_EXISTS] = std::make_pair("Invalid Level Doesn't Exist",
                                                            "|CR|04Invalid, Level doesn't exist.|CR");

    // Menu Field Edit
    value[PROMPT_LEVEL_FIELD_INPUT_TEXT] = std::make_pair("Level Field Edit Prompt",
                                                          "|CR|15Level Editor C|07om|08mand |15: |07");

    // NOTE, added |PD will display the prompt description as HELP text to the user
    // Usefull when editing fields - Specific to XRM.
    value[PROMPT_LEVEL_FIELD_NAME] = std::make_pair("Level Name",
                                                    "|CR|03%   |15|PD|CR|11!   |03(|11A|03) |15Level Name         : ");
    value[PROMPT_LEVEL_FIELD_START_MENU] = std::make_pair("Start Menu",
                                                          "|CR|03%   |15|PD|CR|11!   |03(|11B|03) |15Start Menu         : ");
    value[PROMPT_LEVEL_FIELD_FILE_LEVEL] = std::make_pair("File Level",
                                                          "|CR|03%   |15|PD|CR|11!   |03(|11C|03) |15File Level         : ");
    value[PROMPT_LEVEL_FIELD_MESG_LEVEL] = std::make_pair("Message Level",
                                                          "|CR|03%   |15|PD|CR|11!   |03(|11D|03) |15Message Level      : ");
    value[PROMPT_LEVEL_FIELD_POST_CALL_RATIO] = std::make_pair("Post/Call Ratio",
                                                               "|CR|03%   |15|PD|CR|11!   |03(|11E|03) |15Post/Call Ratio    : ");
    value[PROMPT_LEVEL_FIELD_FILE_RATIO] = std::make_pair("File Ratio - Uploads to Downloads",
                                                          "|CR|03%   |15|PD|CR|11!   |03(|11F|03) |15File Ratio         : ");
    value[PROMPT_LEVEL_FIELD_TIME_LIMIT] = std::make_pair("Time Limit Per Day",
                                                          "|CR|03%   |15|PD|CR|11!   |03(|11G|03) |15Time Limit         : ");
    value[PROMPT_LEVEL_FIELD_CALL_LIMIT] = std::make_pair("Call Limit Per Day",
                                                          "|CR|03%   |15|PD|CR|11!   |03(|11H|03) |15Call Limit         : ");
    value[PROMPT_LEVEL_FIELD_DOWNLOADS] = std::make_pair("Download Limits By # of Files",
                                                         "|CR|03%   |15|PD|CR|11!   |03(|11I|03) |15Download Files     : ");
    value[PROMPT_LEVEL_FIELD_DOWNLOAD_MB] = std::make_pair("Download Limit in MBs",
                                                           "|CR|03%   |15|PD|CR|11!   |03(|11J|03) |15Download MBs       : ");
    value[PROMPT_LEVEL_FIELD_ARFLAGS1] = std::make_pair(
        "Access Restriction Flags Group 1 - Type Letters to Add/Remove/Toggle",
        "|CR|03%   |15|PD|CR|11!   |03(|11K|03) |15AR Flags 1         : ");
    value[PROMPT_LEVEL_FIELD_ARFLAGS2] = std::make_pair(
        "Access Restriction Flags Group 2 - Type Letters to Add/Remove/Toggle",
        "|CR|03%   |15|PD|CR|11!   |03(|11L|03) |15AR Flags 2         : ");

    value[PROMPT_LEVEL_BOOL_POST_CALL_RATIO] = std::make_pair("Enable Post/Call Ratio",
                                                              "|CR|03%   |15|PD|CR|11!   |03(|11M|03) |15Use Post/Call Ratio |07(|15T|07/|15F|07)|15: ");
    value[PROMPT_LEVEL_BOOL_FILE_RATIO] = std::make_pair("Enable File Ratio",
                                                         "|CR|03%   |15|PD|CR|11!   |03(|11N|03) |15Use File Ratio |07(|15T|07/|15F|07)|15    : ");
    value[PROMPT_LEVEL_BOOL_TIME_LIMIT] = std::make_pair("Enable Time Limit",
                                                         "|CR|03%   |15|PD|CR|11!   |03(|11P|03) |15Use Time Limit |07(|15T|07/|15F|07)|15    : ");
    value[PROMPT_LEVEL_BOOL_CALL_LIMIT] = std::make_pair("Enable Call Limit",
                                                         "|CR|03%   |15|PD|CR|11!   |03(|11P|03) |15Use Call Limit |07(|15T|07/|15F|07)|15    : ");
    value[PROMPT_LEVEL_BOOL_DOWNLOADS] = std::make_pair("Enable Download Limits by Files",
                                                        "|CR|03%   |15|PD|CR|11!   |03(|11R|03) |15Use Download Files |07(|15T|07/|15F|07)|15: ");
    value[PROMPT_LEVEL_BOOL_DOWNLOAD_MB] = std::make_pair("Enable Download Limit in MBs",
                                                          "|CR|03%   |15|PD|CR|11!   |03(|11S|03) |15Use Download MBs |07(|15T|07/|15F|07)|15  : ");
    ...
    value[DISPLAY_LEVEL_FIELD_POST_CALL_RATIO] = std::make_pair("Post/Call Ratio",
                                                                " |03(|11E|03) |15Post/Call Ratio    : ");
    value[DISPLAY_LEVEL_FIELD_FILE_RATIO] = std::make_pair("File Ratio - Uploads to Downloads",
                                                           " |03(|11F|03) |15File Ratio         : ");
    value[DISPLAY_LEVEL_FIELD_TIME_LIMIT] = std::make_pair("Time Limit Per Day",
                                                           " |03(|11G|03) |15Time Limit         : ");
    value[DISPLAY_LEVEL_FIELD_CALL_LIMIT] = std::make_pair("Call Limit Per Day",
                                                           " |03(|11H|03) |15Call Limit         : ");
    value[DISPLAY_LEVEL_FIELD_DOWNLOADS] = std::make_pair("Download Limits By # of Files",
                                                          " |03(|11I|03) |15Download Files     : ");
    value[DISPLAY_LEVEL_FIELD_DOWNLOAD_MB] = std::make_pair("Download Limit in MBs",
                                                            " |03(|11J|03) |15Download MBs       : ");
    value[DISPLAY_LEVEL_FIELD_ARFLAGS1] = std::make_pair("Access Control Flags 1",
                                                         " |03(|11K|03) |15AR Flags 1         : ");
    value[DISPLAY_LEVEL_FIELD_ARFLAGS2] = std::make_pair("Access Control Flags 2",
                                                         " |03(|11L|03) |15AR Flags 2         : ");
    value[DISPLAY_LEVEL_BOOL_POST_CALL_RATIO] = std::make_pair("Enable Post/Call Ratio",
                                                               " |03(|11M|03) |15Use Post/Call Ratio: ");
    value[DISPLAY_LEVEL_BOOL_FILE_RATIO] =
            std::make_pair("Enable File Ratio", " |03(|11N|03) |15Use File Ratio     : ");
    value[DISPLAY_LEVEL_BOOL_TIME_LIMIT] =
            std::make_pair("Enable Time Limit", " |03(|11O|03) |15Use Time Limit     : ");
    value[DISPLAY_LEVEL_BOOL_CALL_LIMIT] =
            std::make_pair("Enable Call Limit", " |03(|11P|03) |15Use Call Limit     : ");
    value[DISPLAY_LEVEL_BOOL_DOWNLOADS] = std::make_pair("Enable Download Limits by Files",
                                                         " |03(|11R|03) |15Use Download Files : ");
    value[DISPLAY_LEVEL_BOOL_DOWNLOAD_MB] = std::make_pair("Enable Download Limit in MBs",
                                                           " |03(|11S|03) |15Use Download MBs   : ");

    value[DISPLAY_LEVEL_FIELDS_QUIT_SAVE] = std::make_pair("Quit and Save", " |03(|11Q|03) |15Quit & Save          ");
    value[DISPLAY_LEVEL_FIELDS_QUIT_ABORT] = std::make_pair("Quit without Save",
...
void ModLevelEditor::setupLevelEditor() {
    ...
    if (m_level_display_list.empty()) {
        // Clear Out list if anything already exists.
        std::vector<std::string>().swap(m_level_display_list);
    }

    m_level_display_list = m_ctx.getIoCommon().splitString(level_display_output, '\n');
    m_page = 0;
...
void ModLevelEditor::setupLevelEditFields() {
    ...
    m_ctx.getIoCommon().toUpper(display_name);
...
void ModLevelEditor::displayCurrentPage(const std::string &input_state) {
    ...
    for (unsigned int i = (m_page * (m_rows_per_page - 2)); i < m_level_display_list.size(); i++) {
        std::string display_line = m_ctx.getIoSession().pipe2ansi(m_level_display_list[i]);
        display_line.append("\r\n");
...
void ModLevelEditor::displayCurrentEditPage(const std::string &input_state) {
    ...
    switch (m_mod_setup_index) {
        ...
        default:
            m_log.log(UtilLog::LogLevel::Error,
                      "Error, forgot to add new STATE index displayCurrentEditPage!!", __LINE__, __FILE__);
            return;
    }
...
void ModLevelEditor::levelEditorLevelFieldInput(const std::string &input) {
    ...
    if (result == "aborted") {
        ...
        AcsBase acs;
        AccessLevel current_level = getCurrentLevel();

        if (current_level.iId == -1) {
            return;
        }
        ...
        switch (toupper(key[0])) {
            case 'A': // Level Name
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length, current_level.sName);
                break;
            ...
            case 'B': // Level Start Menu
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length, current_level.sStartMenu);
                break;
            ...
            case 'C': // Level File Level
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length,
                                                   std::to_string(current_level.iFileLevel));
                break;
            ...
            case 'D': // Level Message Level
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length,
                                                   std::to_string(current_level.iMessageLevel));
                break;
            ...
            case 'E': // Level Post/Call Ratio
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length,
                                                   std::to_string(current_level.iPostCallRatio));
                break;
            ...
            case 'F': // Level File Ratio
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length,
                                                   std::to_string(current_level.iFileRatio));
                break;
            ...
            case 'G': // Level Time Limit
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length,
                                                   std::to_string(current_level.iTimeLimit));
                break;
            ...
            case 'H': // Level Call Limit
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length,
                                                   std::to_string(current_level.iCallLimit));
                break;
            ...
            case 'I': // Level Downloads
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length,
                                                   std::to_string(current_level.iDownloads));
                break;
            ...
            case 'J': // Level Downloads MB
                ...
                m_ctx.getIoSession().getInputField("", key, Config::sName_length,
                                                   std::to_string(current_level.iDownloadMB));
                break;
            ...
            case 'M': // Bool PostCallRatio
            {
                ...
                bool_value = m_ctx.getIoCommon().boolAlpha(current_level.bPostCallRatio).at(0);
            ...
            case 'Q': // Quit
                saveLevelChanges();
                std::vector<AccessLevel>().swap(m_loaded_levels);
...
void ModLevelEditor::levelEditorLevelFieldHandler(const std::string &input) {
    ...
    if (result[0] == '\n') {
        ...
        switch (m_current_field) {
            ...
            case 'C': // Level File Level
                current_level.iFileLevel = m_ctx.getIoCommon().stringToInt(key);
                break;

            case 'D': // Level Message Level
                current_level.iMessageLevel = m_ctx.getIoCommon().stringToInt(key);
                break;

            case 'E': // Level Post/Call Ratio
                current_level.iPostCallRatio = m_ctx.getIoCommon().stringToInt(key);
                break;

            case 'F': // Level File Ratio
                current_level.iFileRatio = m_ctx.getIoCommon().stringToInt(key);
                break;

            case 'G': // Level Time Limit
                current_level.iTimeLimit = m_ctx.getIoCommon().stringToInt(key);
                break;

            case 'H': // Level Call Limit
                current_level.iCallLimit = m_ctx.getIoCommon().stringToInt(key);
                break;

            case 'I': // Level Downloads
                current_level.iDownloads = m_ctx.getIoCommon().stringToInt(key);
                break;

            case 'J': // Level Downloads MB
                current_level.iDownloadMB = m_ctx.getIoCommon().stringToInt(key);
                break;
            ...
            case 'M': // Bool PostCallRatio
                current_level.bPostCallRatio = m_ctx.getIoCommon().stringToBool(key);
                break;

            case 'N': // Bool File Ratio
                current_level.bFileRatio = m_ctx.getIoCommon().stringToBool(key);
                break;

            case 'O': // Bool Time Limit
                current_level.bTimeLimit = m_ctx.getIoCommon().stringToBool(key);
                break;

            case 'P': // Bool Call Limit
                current_level.bCallLimit = m_ctx.getIoCommon().stringToBool(key);
                break;

            case 'R': // Bool Download File Limit
                current_level.bDownloads = m_ctx.getIoCommon().stringToBool(key);
                break;

            case 'S': // Bool Download Limit MB
                current_level.bDownloadMB = m_ctx.getIoCommon().stringToBool(key);
                break;
...
void ModLevelEditor::createNewLevel(int level_code) {
    AccessLevelDao level_dao(m_ctx.getDatabase());
    AccessLevel new_level;

    // Check if Level Already Exists.
    AccessLevel destination_level = level_dao.getAccessLevelByLevel(level_code);

    if (checkLevelExistsByLevel(level_code)) {
        m_log.log(UtilLog::LogLevel::Error,
                  "Error, Destination level already exists=", level_code, __LINE__, __FILE__);
        return;
    }
    ...
    if (level_dao.insertRecord(new_level) < 0) {
        m_log.log(UtilLog::LogLevel::Error,
                  "Error, unable to insert new level=", level_code, __LINE__, __FILE__);
    }
}
...
void ModLevelEditor::deleteExistingLevel(int level_code) {
    AccessLevelDao level_dao(m_ctx.getDatabase());
    AccessLevel existing_level = level_dao.getAccessLevelByLevel(level_code);

    if (existing_level.iId == -1 || !level_dao.deleteRecord(existing_level.iId)) {
        m_log.log(UtilLog::LogLevel::Error,
                  "Error, unable to delete existing level=", level_code, __LINE__, __FILE__);
    }
...
void ModLevelEditor::copyExistingLevel(int level_code) {
    AccessLevelDao level_dao(m_ctx.getDatabase());
    AccessLevel existing_level = level_dao.getAccessLevelByLevel(m_current_level);

    if (checkLevelExistsByLevel(level_code)) {
        m_log.log(UtilLog::LogLevel::Error, "Error, Destination level already exists=", level_code, __LINE__, __FILE__);
        return;
    }
    ...
    if (level_dao.insertRecord(existing_level) < 0) {
        m_log.log(UtilLog::LogLevel::Error,
                  "Error, unable to copy existing level=", m_current_level, "to=", level_code, __LINE__, __FILE__);
    }
}
...
void ModLevelEditor::saveLevelChanges() {
    ...
    if (existing_level.iId == -1 || !level_dao.updateRecord(existing_level)) {
        m_log.log(UtilLog::LogLevel::Error,
                  "Error, unable to update existing level=", m_current_level, __LINE__, __FILE__);
        return;
    }
 ...
 */
AccessLevel &ModLevelEditor::getCurrentLevel() {
    for (auto &level: m_loaded_levels) {
        if (level.iLevel == m_current_level) {
            return level;
        }
    }

    // Logic error: The program state is invalid if we get here
    throw std::runtime_error("Current level ID not found in loaded levels.");
}
...
std::string ModLevelEditor::displayLevelList() {
    ...
    // Clear All Levels
    if (!m_loaded_levels.empty()) {
        m_loaded_levels.clear();
        m_loaded_levels.shrink_to_fit();
    }
    ...
    sort(
        ...
        [ ](const AccessLevel &lhs, const AccessLevel &rhs) {
    ...
    if (m_loaded_levels.empty()) {
        result_set.push_back(baseGetDefaultStatColor() + m_ctx.getIoCommon().rightPadding("No Records Found!", 24));
    }

    // Build a string list of individual menu options, then loop to fit as many per screen!
    for (unsigned int i = 0; i < m_loaded_levels.size(); i++) {
        std::string option_string = m_ctx.getIoCommon().rightPadding(std::to_string(m_loaded_levels[i].iLevel), 5);
        option_string.
                append(baseGetDefaultStatColor() + m_ctx.getIoCommon().rightPadding(m_loaded_levels[i].sName, 19));
...
std::string ModLevelEditor::displayLevelEditScreen() {
    ...
    if (current_level.iId == -1) {
        m_log.log(UtilLog::LogLevel::Error, "Error, Level Not Found=", m_current_level, __LINE__, __FILE__);
    ...
    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_NAME) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(current_level.sName, 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_START_MENU) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(current_level.sStartMenu, 48));


    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_FILE_LEVEL) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(std::to_string(current_level.iFileLevel), 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_MESG_LEVEL) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(std::to_string(current_level.iMessageLevel), 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_POST_CALL_RATIO) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(std::to_string(current_level.iPostCallRatio), 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_FILE_RATIO) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(std::to_string(current_level.iFileRatio), 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_TIME_LIMIT) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(std::to_string(current_level.iTimeLimit), 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_CALL_LIMIT) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(std::to_string(current_level.iCallLimit), 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_DOWNLOADS) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(std::to_string(current_level.iDownloads), 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_DOWNLOAD_MB) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(std::to_string(current_level.iDownloadMB), 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_ARFLAGS1) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(acs.getAcsFlagsFromBits(current_level.iARFlags1), 48));

    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELD_ARFLAGS2) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding(acs.getAcsFlagsFromBits(current_level.iARFlags2), 48));


    result_set.push_back(
        m_ctx.getIoCommon().rightPadding(
            getDisplayPromptRaw(DISPLAY_LEVEL_BOOL_POST_CALL_RATIO) + baseGetDefaultStatColor() + m_ctx.getIoCommon().
            boolAlpha(
                current_level.bPostCallRatio), 56) +
        m_ctx.getIoCommon().rightPadding(
            getDisplayPromptRaw(DISPLAY_LEVEL_BOOL_CALL_LIMIT) + baseGetDefaultStatColor() + m_ctx.getIoCommon().
            boolAlpha(
                current_level.bCallLimit), 56));


    result_set.push_back(
        m_ctx.getIoCommon().rightPadding(
            getDisplayPromptRaw(DISPLAY_LEVEL_BOOL_FILE_RATIO) + baseGetDefaultStatColor() + m_ctx.getIoCommon().
            boolAlpha(
                current_level.bFileRatio), 56) +
        m_ctx.getIoCommon().rightPadding(
            getDisplayPromptRaw(DISPLAY_LEVEL_BOOL_DOWNLOADS) + baseGetDefaultStatColor() + m_ctx.getIoCommon().
            boolAlpha(
                current_level.bDownloads), 56));

    result_set.push_back(
        m_ctx.getIoCommon().rightPadding(
            getDisplayPromptRaw(DISPLAY_LEVEL_BOOL_TIME_LIMIT) + baseGetDefaultStatColor() + m_ctx.getIoCommon().
            boolAlpha(
                current_level.bTimeLimit), 56) +
        m_ctx.getIoCommon().rightPadding(
            getDisplayPromptRaw(DISPLAY_LEVEL_BOOL_DOWNLOAD_MB) + baseGetDefaultStatColor() + m_ctx.getIoCommon().
            boolAlpha(
                current_level.bDownloadMB), 56));
    ...
    result_set.push_back(getDisplayPromptRaw(DISPLAY_LEVEL_FIELDS_QUIT_SAVE) + baseGetDefaultStatColor() +
                         m_ctx.getIoCommon().rightPadding("", 48));
