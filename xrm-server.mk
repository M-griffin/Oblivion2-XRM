...
$(IntermediateDirectory)/src_encryption.cpp$(ObjectSuffix): src/encryption.cpp $(IntermediateDirectory)/src_encryption.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/Test2/src/encryption.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_encryption.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_data_security_dao.cpp$(ObjectSuffix): src/data/security_dao.cpp $(IntermediateDirectory)/src_data_security_dao.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/Test2/src/data/security_dao.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_data_security_dao.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_data_security_dao.cpp$(DependSuffix): src/data/security_dao.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_data_security_dao.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_data_security_dao.cpp$(DependSuffix) -MM "src/data/security_dao.cpp"

$(IntermediateDirectory)/src_data_security_dao.cpp$(PreprocessSuffix): src/data/security_dao.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_data_security_dao.cpp$(PreprocessSuffix) "src/data/security_dao.cpp"
...
$(IntermediateDirectory)/src_mods_mod_prelogon.cpp$(ObjectSuffix): src/mods/mod_prelogon.cpp $(IntermediateDirectory)/src_mods_mod_prelogon.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/Test2/src/mods/mod_prelogon.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_mods_mod_prelogon.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_mods_mod_prelogon.cpp$(DependSuffix): src/mods/mod_prelogon.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_mods_mod_prelogon.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_mods_mod_prelogon.cpp$(DependSuffix) -MM "src/mods/mod_prelogon.cpp"

$(IntermediateDirectory)/src_mods_mod_prelogon.cpp$(PreprocessSuffix): src/mods/mod_prelogon.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_mods_mod_prelogon.cpp$(PreprocessSuffix) "src/mods/mod_prelogon.cpp"

$(IntermediateDirectory)/src_mods_mod_signup.cpp$(ObjectSuffix): src/mods/mod_signup.cpp $(IntermediateDirectory)/src_mods_mod_signup.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/Test2/src/mods/mod_signup.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_mods_mod_signup.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_mods_mod_signup.cpp$(DependSuffix): src/mods/mod_signup.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_mods_mod_signup.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_mods_mod_signup.cpp$(DependSuffix) -MM "src/mods/mod_signup.cpp"

$(IntermediateDirectory)/src_mods_mod_signup.cpp$(PreprocessSuffix): src/mods/mod_signup.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_mods_mod_signup.cpp$(PreprocessSuffix) "src/mods/mod_signup.cpp"
